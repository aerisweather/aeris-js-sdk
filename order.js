...
(function () {
    ...
    function onFetchOnly(node) {
        ...
        for (i = 0; (resourceName = scriptWaiting[i]); i++) {
            ...
            if (loadedNode &&
                ...
                Aeris.require.addScriptToDom(loadedNode);
            } else {
                break;
            }
        }
    ...
    Aeris.define({
        ...
        load: function (name, req, onLoad, config) {
            ...
            //this script.
            Aeris.require.s.skipAsync[url] = true;
            if (supportsInOrderExecution || config.isBuild) {
                ...
                context = Aeris.require.s.contexts._;
                ...
                if (!context.urlFetched[url] && !context.loaded[name]) {
                    ...
                    Aeris.require.resourcesReady(false);
                    context.scriptCount += 1;

                    //Fetch the script now, remember it.
                    node = Aeris.require.attach(url, context, name, null, null, onFetchOnly);
                ...
                if (req.specified(name)) {
                    ...
                    Aeris.require.attach(url, null, name, scriptCacheCallback, "script/cache");
                }
            }
        }
    });
